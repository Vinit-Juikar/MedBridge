...
import 'package:medbridge/doctorHomeScreen/medical_history.dart';

import '../login/firebase/auth.dart';

class DoctorViewAppointment extends StatelessWidget {
  var appId;
  DoctorViewAppointment(this.appId, {super.key});
  ...
  Widget build(BuildContext context) {
    ...
    doctor.get().then((DocumentSnapshot documentSnapshot) {
      if (documentSnapshot.exists) {
        patientName = documentSnapshot.get('patientName');
